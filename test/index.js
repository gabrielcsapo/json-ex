...
test('json-ex', (t) => {
    ...
    t.test('should be able to stringify a complex javascript object', (t) => {
        ...
        const output = JSONex.stringify(object);
        t.equal(output, `{"name":"Hello world","person":true,"age":100000,"buffer":"_BuffEx_{\\"type\\":\\"Buffer\\",\\"data\\":[104,105]}","date":"_DateEx_${object.date.toISOString()}","func":"function hello() { return \'hello world\' }","reg":"_PxEgEr_/%name%/"}`);
        t.end();
    });
