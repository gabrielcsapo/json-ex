...
test('json-ex', (t) => {
    ...
    t.test('should be able to stringify a complex javascript object', (t) => {
        ...
        const output = JSONex.stringify(object);
        t.equal(output, `{"name":"Hello world","person":true,"age":100000,"buffer":"_BuffEx_%7B%22type%22%3A%22Buffer%22%2C%22data%22%3A%5B104%2C105%5D%7D","date":"_DateEx_${encode(moment(date).toISOString())}","func":"_FuncRa_function%20hello()%20%7B%20return%20&#39;hello%20world&#39;%20%7D","reg":"_PxEgEr_%5B%22%25name%25%22%2C%22%22%5D"}`);
        t.end();
    });
